...
public class LuckyWheelView extends RelativeLayout implements PielView.PieRotateListener {
    ...
    private void init(Context ctx, AttributeSet attrs) {
        if (attrs != null) {
            ...
            mMiddleTextPadding = typedArray.getDimensionPixelSize(R.styleable.LuckyWheelView_lkwMiddleTextPadding, (int) LuckyWheelUtils.convertDpToPixel(10f, getContext())) + (int) LuckyWheelUtils.convertDpToPixel(10f, getContext());
        ...
        pielView.setMiddleTextPadding(mMiddleTextPadding);
